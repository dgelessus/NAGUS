...
.. cpp:class:: plNetMsgGameMessageDirected : public plNetMsgGameMessage
  ...
  * **Receivers:** Variable-length array of 4-byte unsigned ints,
  ...
  The wrapped :cpp:class:`plMessage` should be an instance of :cpp:class:`pfKIMsg`, ``plCCRCommunicationMsg``, :cpp:class:`plAvatarInputStateMsg`, :cpp:class:`plInputIfaceMgrMsg`, or :cpp:class:`plNotifyMsg`.
