...
I'm trying to comment the source code in detail,
in the hope that it might serve as documentation for Uru's network protocol and architecture
(which at the moment is not documented much).
...
To clarify the scope of this project:
...
see the `Uru <https://www.guildofwriters.org/wiki/Uru>`__ and `Plasma <https://www.guildofwriters.org/wiki/Plasma>`__ pages on the Guild of Writers wiki.

With all of that out of the way,
let's get to the actual topic:
the MOULa network architecture.
...
Here is a list and short explanation of all the different server types.
