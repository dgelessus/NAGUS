...
CITY_V43_HEADER = _make_header(b"city", 43)
...
CLEFT_V24_HEADER = _make_header(b"Cleft", 24)
...
NEIGHBORHOOD_V35_HEADER = _make_header(b"Neighborhood", 35)
...
PERSONAL_V41_HEADER = _make_header(b"Personal", 41)
